...
(autothemer-deftheme
 ...
 (
  ...
  (mode-line                            (:background dark))
  (mode-line-inactive                   (:background surface2 :foreground subtext1))
  (mode-line-active		                (:foreground subtext1 :bold t))
  ...
  (doom-modeline-buffer-file            (:foreground green :bold t))
  ...
  ;; Flycheck
  (flycheck-posframe-background-face	(:background dark))
  (flycheck-posframe-face				(:background dark))
  (flycheck-posframe-info-face  		(:background dark :inherit 'info))
  (flycheck-posframe-warning-face  		(:background dark :inherit 'warning))
  (flycheck-posframe-error-face  		(:background dark :inherit 'error))
