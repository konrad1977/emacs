...
(autothemer-deftheme
 ...
 (
  ...
  (font-lock-delimiter-face             (:foreground muted))
  ...
  (font-lock-misc-face                  (:foreground gold :weight 'thin))
  ...
  (font-lock-property-use-face          (:foreground rose))
  (font-lock-punctuation-face           (:foreground muted))
