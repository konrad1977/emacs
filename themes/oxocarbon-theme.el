...
(autothemer-deftheme
 ...
 (
  ...
  (mode-line-buffer-id                  (:foreground rose :background 'unspecified :bold t))

  (numbers                              (:background gold))
  (region                               (:background blue :foreground crust))
  ...
  (font-lock-builtin-face               (:foreground pine :weight 'normal))
  ...
  (font-lock-delimiter-face             (:foreground love))
  ...
  (font-lock-keyword-face               (:foreground pink :weight 'normal))
  ...
  (font-lock-type-face                  (:foreground iris :weight 'normal))
  (font-lock-variable-name-face         (:foreground rose :weight 'light))
  (font-lock-variable-use-face          (:foreground pine-light))
  ...
  (swift-ts-face-compiler                        (:foreground foam :weight 'semi-bold :italic t))
  ...
  (highlight-symbol-face                (:background medium-foam :italic t))
  ...
  (isearch (:background gold :foreground dark-gold :weight 'bold :underline t))
  (lazy-highlight (:background gold :foreground dark-gold :weight 'bold :underline t))
  ...
  (periphery-note-face-full (:foreground pine :background dark-green :bold t))
  (periphery-mark-face-full (:foreground overlay :background muted :bold t))
  (periphery-todo-face-full (:foreground foam :background dark-foam :bold t))
  (periphery-hack-face-full (:foreground pink :background dark-love :bold t))
  ...
  ;; (diff-refine-added (:foreground medium-green))
  ;; (diff-refine-changed (:foreground medium-gold))
  ;; (diff-refine-removed (:foreground medium-love))

  (diff-hl-insert (:foreground foam))
  (diff-hl-change (:foreground gold))
  (diff-hl-delete (:foreground love))
  ...
  (knockknock-icon-face (:foreground foam :background dark-foam :weight 'bold))
  (knockknock-title-face (:foreground foam 'bold))
