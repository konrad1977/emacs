...
(autothemer-deftheme
 ...
 (
  ...
  (mode-line-inactive                   (:background base :foreground subtext1))
  ...
  (flycheck-inline-error                (:foreground red :background red :height 128))
  (flycheck-inline-info                 (:foreground blue :background blue :height 128))
  (flycheck-inline-warning              (:foreground yellow :background yellow :height 128))
  ...
  (highlight-indent-guides-stack-even-face      (:foreground surface0))
  (highlight-indent-guides-stack-character-face (:foreground surface0))
  (highlight-indent-guides-even-face            (:foreground surface0))
  (highlight-indent-guides-odd-face             (:foreground surface0))
