...
(autothemer-deftheme
 ...
 ((default                              (:background base :foreground text))
  ...
  (swift-ts-face-keyword.type                    (:inherit 'font-lock-keyword-face))
  (swift-ts-face-compiler                        (:inherit 'font-lock-preprocessor-face))
  (swift-ts-face-variable.synthesized            (:inherit 'font-lock-variable-name-face :italic t))
  ...
  (diff-hl-margin-change (:foreground blue))
